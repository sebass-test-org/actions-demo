...
curl -H "Authorization: token ${GITHUB_TOKEN}" -d '{"state": "success", "environment_url": "https://${DEPLOYMENT_URL}"}' https://api.github.com/repos/${GITHUB_REPOSITORY}/deployments/${DEPLOYMENT_ID}/statuses
